...
String classe = "";
    ...
    if(request.getMethod().equals("POST")){
        ...
        //popular com o q ele digitou no form
...
<div class="row">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <i class="fa fa-file"></i> Listagem de Registro
            </li>
        </ol>
    </div>
</div>
        ...
        <div class="panel-body">
            ...
            <form action="../UploadWS" method="post" enctype="multipart/form-data">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        <label>Foto:</label>                        
                    <input type="file" name="txtFoto" id="arquivo1"  accept="image/*" />
